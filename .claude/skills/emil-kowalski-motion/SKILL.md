...
description: Emil Kowalski's design engineering philosophy for animation and UI polish: easing/duration decision framework, spring physics, component-level details (buttons, popovers, tooltips), clip-path techniques, gesture/drag interactions, and performance rules. Use when writing or reviewing any UI animation, transition, or micro-interaction in code or an HTML artifact.
---

> Source: ported from the open-source "emilkowalski/skills" project (github.com/emilkowalski/skills, skill: emil-design-eng), by Emil Kowalski (animations.dev).
