---
name: design-taste
description: Anti-slop frontend design skill for landing pages, portfolios, and redesigns. Reads the brief, infers the right design direction, and avoids AI design tells (AI-purple gradients, em-dashes, three-equal-card rows, eyebrow spam, beige+brass palettes) so output doesn't look templated. Use whenever building or redesigning a marketing page, portfolio, or landing page as code (HTML/React/Tailwind) or as an HTML artifact.
---
